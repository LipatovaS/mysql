...
INSERT INTO users1 (name, birthday_at, created_at, updated_at) 
VALUE ('Василий', '1990-10-05', '20.10.2017 8:10', '22.10.2017 5:10');
...
ALTER TABLE users1 MODIFY created_at DATETIME;   
ALTER TABLE users1 MODIFY updated_at DATETIME; 

CREATE TABLE value (value CHAR(5));
...
INSERT INTO value VALUES
  ...
  SELECT ROUND(exp(SUM(log(value))), 0) AS factorial FROM `value`;
